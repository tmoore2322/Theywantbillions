...
const BUILDINGS = {
  ...
  gate:       { name:'Gate', w:1, h:1, hp:700, cost:{wood:15, stone:5}, tab:'frontier', kind:'defense', gate:true, height:1.0,
                color:'#7a4a22', trim:'#d9b45a', desc:'Your units pass. The Wave does not. Gates are weapons. Tankies want them.' },
...
const UNITS = {
  ...
  tankie:    { name:'Tankie', side:'enemy', hp:700, speed:0.9, dmg:8, bdmg:25, rate:0.7, range:1.3, r:0.45, armor:6,
               aggro:7, prefer:['gate','tower','tower_stone'], desc:'Armored star brute. Ignores 6 damage per hit. Breaks gates and towers and escorts the rest in.' },
  ...
  thicc:     { name:'Thicc Support', side:'enemy', hp:300, speed:1.3, dmg:4, bdmg:2, rate:0.8, range:1.3, r:0.42,
               aggro:6, heals:{ types:['manchild','tankie','goon'], radius:3, rate:9 }, desc:'Body positivity on a mobility scooter. Rolls with the blob and heals Man-Children, Tankies and Goons 9 HP/s with affirmations. "Every body is a wave body." Marksman food.' },
  // ---- lieutenants ----
  ...
  gosplan:   { name:'Gosplan Annex', title:'The Walking Filing Hall', side:'enemy', hp:3600, speed:0.75, dmg:8, bdmg:18, rate:0.8, range:1.6, r:0.7, armor:5, lt:true, boss:true,
               aggro:99, prefer:['workshop','mill','quarry','mine','townhall'], siphon:{ share:0.3, cap:100 }, desc:'Walking filing hall. Siphons 30% of your income into a Public Fund bar; every time it fills, a Tankie steps out of the stacks.' },
  ...
  marksman:  { name:'Marksman', side:'player', hp:70, speed:2.2, dmg:42, rate:0.4, range:8.0, r:0.24,
               ...
               desc:'Deletes specials. Range 8, slow fire, prefers Man-Children, Thicc Support, vans and megaphones over Activists.' },
...
const WAVES = {
  ...
  9:  { activist:50, organizer:10, manchild:3, agitprop:2, seizure:2, goon:4, tankie:1 },
  10: { activist:54, organizer:12, manchild:4, agitprop:2, seizure:2, goon:5, tankie:1, nevertheless:1, lt:'sernie' },
  11: { activist:58, organizer:12, manchild:4, agitprop:2, seizure:3, goon:6, tankie:2, nevertheless:1 },
  12: { activist:62, organizer:14, manchild:5, agitprop:3, seizure:3, goon:6, tankie:2, nevertheless:2, thicc:1, lt:'liz' },
  13: { activist:66, organizer:14, manchild:5, agitprop:3, seizure:4, goon:8, tankie:3, nevertheless:2, thicc:2 },
  14: { activist:70, organizer:16, manchild:6, agitprop:3, seizure:4, goon:8, tankie:3, nevertheless:2, thicc:2, lt:'alex' },
  15: { activist:76, organizer:16, manchild:6, agitprop:3, seizure:5, goon:10, tankie:4, nevertheless:3, thicc:3 },
  16: { activist:100, organizer:20, manchild:8, agitprop:4, seizure:6, goon:12, tankie:5, nevertheless:4, thicc:4 },
  17: { activist:70, organizer:14, manchild:5, agitprop:3, seizure:4, goon:8, tankie:3, nevertheless:2, thicc:2, boss:'warcommunism' },
  18: { activist:74, organizer:14, manchild:5, agitprop:3, seizure:5, goon:8, tankie:3, nevertheless:3, thicc:3, boss:'gosplan' },
  19: { activist:78, organizer:16, manchild:6, agitprop:3, seizure:5, goon:9, tankie:4, nevertheless:3, thicc:3, boss:'listening' },
  20: { activist:120, organizer:22, manchild:9, agitprop:4, seizure:7, goon:12, tankie:6, nevertheless:4, thicc:4, boss:'committee', lt:'random' },
};
